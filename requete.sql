...
create table module(id_m SERIAL PRIMARY KEY, nom_m VARCHAR(255), cm_g INTEGER, td_g INTEGER, tp_g INTEGER);
...
create table programme(id_prog SERIAL PRIMARY KEY, ppn BOOLEAN);
