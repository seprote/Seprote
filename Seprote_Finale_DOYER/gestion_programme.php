		...
		<div id="content">
			...
			<div id="dialog_for" title="Création nouvelle formation">  
				...
				<fieldset>
					...
					<input type="text" name="nom_for" id="nom_for"  class="text ui-widget-content ui-corner-all">
					<label for="annee">Année concernée</label>
					<select name="annee" id="for_annee"> 
						<option value=""></option>
						<?php echo($liste_annee); ?>
					</select>
					<label for="nb_td">Nombre de groupe TD:</label>
					<input type="number" name="nb_td" id="nb_td"  class="text ui-widget-content ui-corner-all">
					<label for="nb_tp">Nombre de goupe TP:</label>
