	...
	/************ TRAITEMENT FORMULAIRE ************/
		...
		if(isset($_POST['type_form'])){
			...
			if($_POST['type_form'] == 2){
				...
				if(isset($_POST["id"]) && isset($_POST["nom"]) && isset($_POST["prenom"]) && isset($_POST["mail"])){

					$req = $bdd->prepare('UPDATE utilisateur SET id_u = :id, nom = :nom, prenom = :prenom, mail = :mail WHERE id_u = :id');
					$req->execute(array(
						"nom"=> $_POST["nom"],
						"prenom"=> $_POST["prenom"],
						"mail"=> $_POST["mail"],
				...
				<div id="content">
					...
					<?php
						...
						<div id="dialog_edit" title="Edition de compte">  
                             				...
                             				<form name="edit_compte" method="POST" action="gestion_compte.php">
                               					<fieldset>
